package com.swissborg.akkainspection.main
...
import com.swissborg.akkainspection.{Fragment, ImmutableInspection, MutableInspection}
...
//    }
    ...
    def otherReceive(s2: State): Receive =
      inspect("mainReceive")(s2) //.orElse(???)
