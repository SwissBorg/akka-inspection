...
/**
  ...
  * These methods rely on instance of the [[com.swissborg.akkainspection.inspectable.Inspectable]] typeclass. An instance can be automatically
  ...
  *
  */
trait ImmutableInspection extends ActorInspection with ActorLogging {
  this: Actor =>
